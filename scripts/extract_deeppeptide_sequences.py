            ...
            if peptides:  # Check if there are peptides
                ...
                if gene_sequence:  # If the gene sequence is found in the FASTA
                    ...
                    for peptide in peptides:
                        ...
                        peptide_sequence = gene_sequence[start-1:end]  # Extract peptide sequence
                        peptides_out.write(f">{transcript_id}_peptide_{start}_{end}\n{peptide_sequence}\n")
...
if __name__ == "__main__":
    if len(sys.argv) != 5:
        print("Usage: python extract_deeppeptide_sequences.py <json_file> <fasta_file> <genes_output_file> <peptides_output_file>")
        sys.exit(1)
