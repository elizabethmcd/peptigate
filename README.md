...
It's name is an abbreviated portmanteau of "peptide" and "investigate" -> peptigate.
...
Examples include [preproglucagon](https://doi.org/10.1152/ajpendo.00152.2022), a precursor protein that is cleaved into peptides that regulate insulin secretion in pancreatic beta cells. 
